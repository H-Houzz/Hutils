package com.pictureselector.config;
...
import com.pictureselector.camera.CustomCameraView;
...
public final class PictureSelectionConfig implements Parcelable {
    public String isLimitSize = "";//限制宽高大小 ，自加
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeString(this.isLimitSize);
    ...
    protected PictureSelectionConfig(Parcel in) {
        this.isLimitSize = in.readString();
