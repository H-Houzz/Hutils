package com.pictureselector.adapter;
...
import com.pictureselector.tools.AnimUtils;
...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NotNull final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == PictureConfig.TYPE_CAMERA) {
            ...
            if (!config.isLimitSize.equals("") && image.getWidth() < Integer.parseInt(config.isLimitSize.split("#")[0])  && image.getHeight() < Integer.parseInt(config.isLimitSize.split("#")[1]) ) {
                contentHolder.tv_igi_jinggao.setVisibility(View.VISIBLE);
                contentHolder.tv_igi_jinggao.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ToastUtils.s(context, context.getResources().getString(R.string.picture_width_height_under) + config.isLimitSize.split("#")[0] + "x" + config.isLimitSize.split("#")[1]);
                    }
                });
            } else {
                contentHolder.tv_igi_jinggao.setVisibility(View.GONE);
            }
...
//                }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tv_igi_jinggao = itemView.findViewById(R.id.tv_igi_jinggao);
