...
import com.pictureselector.config.UCropOptions;
import com.pictureselector.engine.CacheResourcesEngine;
import com.pictureselector.engine.ImageEngine;
import com.pictureselector.entity.LocalMedia;
import com.pictureselector.listener.OnCustomCameraInterfaceListener;
import com.pictureselector.listener.OnCustomImagePreviewCallback;
import com.pictureselector.listener.OnResultCallbackListener;
import com.pictureselector.listener.OnVideoSelectedPlayCallback;
import com.pictureselector.style.PictureCropParameterStyle;
import com.pictureselector.style.PictureParameterStyle;
...
public class PictureSelectionModel {
     ...
     * @return
     */
    public PictureSelectionModel isLimitSize(int width, int height) {
        selectionConfig.isLimitSize = width + "#" + height;
        return this;
    }
